...
Ao contrário dos [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Workflows\|Workflows]], que são macros acionadas manualmente pelo usuário via comando `/`, as regras são **acionadas automaticamente por gatilhos de contexto**.
