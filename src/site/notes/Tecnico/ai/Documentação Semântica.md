...
- **Consistência Cross-Agent:** Ele garante que qualquer agente no [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]], ao ler este arquivo via protocolos como o **MCP ([[Tecnico/ai/Model Context Protocol\|Model Context Protocol]])**, mantenha a identidade visual estável em todo o projeto.
