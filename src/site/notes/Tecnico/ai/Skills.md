...
| Modelo            | ✅                                                | ✅                                                                               |
| [[Formacao/Inteligencia Artificial/parametros de LLM/System Prompt\|System Prompt]] | Todas instruções ficam no System Prompt          | System Prompt leve + skills ([[Tecnico/ai/Prompts\|Prompts]]) carregados [[Tecnico/ai/Workflows\|sob demanda]] |
...
- **Stitch Skills:** Quando integradas ao Google Stitch via MCP ([[Tecnico/ai/Model Context Protocol\|Model Context Protocol]]), permitem converter layouts em arquivos **design.md** (fonte da verdade), gerar componentes **React/TypeScript** modulares e criar o **Stitch Loop** (automação para gerar múltiplas páginas em segundo plano).
