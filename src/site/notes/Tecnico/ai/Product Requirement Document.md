---
{"dg-publish":true,"permalink":"/tecnico/ai/product-requirement-document/","metatags":{"description":"documentação central que serve para instruir a inteligência artificial sobre como o projeto deve funcionar"},"noteIcon":2,"updated":"2026-03-18T09:48:53.145-03:00"}
---
...
O PRD é o "cérebro" dinâmico e a [[Tecnico/ai/Documentação Semântica\|documentação central]] que instrui agentes de inteligência artificial sobre como um projeto de software deve funcionar.
...
- **Base para Testes e Auditoria:** Ferramentas de segurança (como o Test Sprite) exigem um PRD em [[Formacao/Webdesign/markdown\|markdown]] para analisar se o sistema construído realmente atende aos [[Formacao/UX design/requisitos\|requisitos]] definidos, funcionando como uma checklist de validação estruturada.
...
3. **Lista de Páginas e Fluxos de Usuário:** Mapeamento de todas as telas e o comportamento esperado ao interagir com botões ou [[Formacao/Webdesign/Formulários\|Formulários]].
...
6. **[[Formacao/UX design/requisitos\|Requisitos]] Não Funcionais:** Diretrizes claras sobre segurança (IAM, OAuth), performance e escalabilidade, que modelos generativos costumam negligenciar se não forem instruídos.
...
Você não precisa escrever o PRD do zero manualmente. No Google [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]], você pode usar **[[Tecnico/ai/Workflows\|Workflows]]** especializados (como o "Genesis" ou o "SAS Builder"):
...
- [[Tecnico/ai/Documentação Semântica\|Documentação Semântica]]
- [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]]
- [[Tecnico/ai/Workflows\|Workflows]]
- [[Formacao/UX design/requisitos\|requisitos]]
