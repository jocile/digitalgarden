...
- **[[Tecnico/PHP/Classes em PHP\|Classes em PHP]]:** Definição e propósito.
- **Atributos (Propriedades):** Características de um objeto.
- **[[Tecnico/PHP/Metodos com PHP\|Metodos com PHP]]:** Ações que um objeto pode realizar.
...
- **Estruturas de [[Tecnico/PHP/Repeticao com PHP\|Repeticao com PHP]] (`foreach`):** Para listar coleções de dados.
