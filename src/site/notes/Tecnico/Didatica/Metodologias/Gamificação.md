...
Dentro do [[Tecnico/Didatica/Planejamento/Modelo pedagogico Senac\|Modelo Pedagógico Senac]] (MPS), a gamificação desloca o centro da aula da exposição para a experiência:
...
*   **Ciclo [[Tecnico/Didatica/Metodologias/Acao-reflexao-segunda-acao\|Ação-Reflexão-Ação]]:** O aluno realiza uma missão (ação), analisa seu desempenho e pontuação (reflexão) e ajusta sua estratégia para o próximo nível (nova ação).
