...
Atuar com as [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] requer ressignificar o papel do docente. Na perspectiva da [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] ativa, ressignificar o papel do professor exige deslocar o papel de docente da figura de sujeito detentor do conhecimento para uma atuação mais próxima da tutoria.

Analisando as [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] em relação à Educação Profissional e ao desenvolvimento de competências, pode-se dizer que:  

- Não há um método de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] ativa que seja mais ou menos indicado para o desenvolvimento de competências. 
- Apesar de revelarem elementos comuns, cada método referenciado na literatura educacional sobre [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] ativa apresenta variações em seus pressupostos teóricos e didáticos. 
- A escolha por um ou outro método de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] ativa pode variar em função dos recursos disponíveis, do planejamento das situações de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] ou até mesmo da preferência do docente.  

A perspectiva da [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] com a utilização de [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] organiza-se a partir de algumas premissas:  
...
Entende-se por [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] um conjunto de procedimentos didáticos que visam promover a participação ativa do aluno nas situações de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]]. Os principais elementos que as caracterizam são: o foco da ação pedagógica no aluno, a presença do docente como mediador do processo de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] e o caráter colaborativo e participativo das atividades desenvolvidas em sala de aula.

As [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de ensino e [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]], em consonância com os pressupostos e orientações para o desenvolvimento de competências no Modelo Pedagógico Senac, devem estar alicerçadas na concepção de aluno como sujeito de seu desenvolvimento educacional.\
O termo destacado pressupõe, como premissa, que o papel do docente deva ser o de mediar o processo de ensino e [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]].\
As [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] favorecem o desenvolvimento da autonomia pelo aluno, que, em vez de receber de forma passiva as informações apresentadas pelo professor, é estimulado a buscar dados, realizar pesquisas, manifestar-se e adotar uma postura crítica em relação à realidade à sua volta. Para tanto, o papel do professor deve ser o de orientar, acompanhar e facilitar o processo de ensino e [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]], sendo, portanto, um mediador desse processo.

As estratégias de [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] constituem uma possibilidade entre várias existentes para o planejamento das aulas e a atuação docente, além de permitir o desenvolvimento da inovação na [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]], em sintonia com a educação do século XXI. Sobre esse conceito, é possível afirmar que:  
...
- O uso de [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] reforça as noções de autonomia, emancipação e desenvolvimento pessoal de alunos e docentes, que, pela via do respeito e da valorização das diferenças, aprendem juntos.  
...
No trabalho com [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]], o docente tem um importante papel de facilitar reflexões e ajudar o aluno a fazer as conexões necessárias à construção do conhecimento. Isso significa que são esperadas do docente ações como fazer perguntas capazes de desafiar os alunos na busca de soluções. Sua ação ganha acento na mediação. Nesse papel, ele considera as informações trazidas pelos alunos e constrói significados coletivos com a sala de aula.

A inovação é bastante estimulada no trabalho com [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]] de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]], e algumas das justificativas para essa prática são:  
...
- Debate
- Relatório
- [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] em ação
- Mapa Mental
- Painel
...
As demais etapas de trabalho na [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] Baseada em Problemas (ABP) envolvem:
...
Na [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] Baseada em Casos (ABC) os casos são construídos ou selecionados a partir dos indicadores de competência e dos elementos a serem mobilizados na Unidade Curricular. Sobre a ABC, pode-se dizer que:  
...
A sala de aula invertida é o método que **inverte a sequência tradicional das situações de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]]**. Nessa proposta, os alunos realizam leituras e pesquisas antes dos encontros presenciais, por meio de recursos como textos, vídeos e áudios. Podem também participar de chats, fóruns, jogos e de outras atividades interativas. Posteriormente, os alunos discutem a temática com o docente e os demais colegas para, então, desenvolver atividades relacionadas à temática.
...
Para a escolha do jogo, é fundamental **estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] e o perfil dos alunos** – considerando as possibilidades que as tecnologias assistivas oferecem –, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho.
...
A escolha do jogo, é fundamental estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] e o perfil dos alunos, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho.

Em uma perspectiva mais atual, o docente pode desenvolver jogos baseados nos elementos e nas dinâmicas dos videogames, nos quais a ação se desenvolve sob um enredo e uma narrativa, com desafios e níveis de dificuldade e progressão. Há, portanto, diversas formas de apropriação dos jogos em contextos pedagógicos. Os jogos educativos, por exemplo, são desenvolvidos para abordar temas relacionados ao currículo, inclusive aqueles relacionados ao desenvolvimento de habilidades, atitudes e valores, tais como integração, empreendedorismo, cooperação e controle das emoções. Para a escolha do jogo, é fundamental estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] e o perfil dos alunos, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho. É também importante que todos esses elementos sejam organizados sob regras claras, com previsão das possibilidades de tentativa e erro, interatividade e interação entre os alunos.

A [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] Baseada em Jogos (gamificação) traz para o universo da sala de aula a dinâmica, a mecânica e os componentes estruturais dos jogos. Dessa forma, os elementos comuns de jogos são utilizados no processo educacional, para além do mero entretenimento, com a finalidade de desafiar o raciocínio e propiciar a [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]]. As etapas para a utilização da [[Tecnico/Didatica/Aprendizagem\|Aprendizagem]] Baseada em Jogos envolvem:  
