---
{"dg-publish":true,"permalink":"/tecnico/didatica/metodologias/dojo/","tags":["metodologia-ativa","didatica","programacao"],"noteIcon":2,"updated":"2026-03-15T09:44:53.298-03:00"}
---


# Dojo (Coding Dojo)

O **Dojo** é uma prática educacional colaborativa e *hands-on* fundamentada nos princípios das [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias Ativas]]. Inspirado nas artes marciais, onde o "Dojo" é o local de treinamento, esta técnica propõe um ambiente seguro para a experimentação de código, onde o foco não é apenas "resolver o problema", mas sim o **processo de aprendizagem coletiva** e a melhoria contínua.
...
- **Coding Dojo** [https://codingdojo.org](https://codingdojo.org/)
...
- **Plataforma Cubus.** [Dojo \| Metodologias de Aprendizagem](https://cubus.oitcinterfor.org/dojo/)
