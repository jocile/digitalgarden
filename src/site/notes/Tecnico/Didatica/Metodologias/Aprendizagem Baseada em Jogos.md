...
A **Aprendizagem Baseada em Jogos (ABJ)**, ou *Game-Based Learning* (GBL), é uma estratégia de [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologia Ativa]] que utiliza a estrutura, as mecânicas e a estética dos jogos para criar experiências de aprendizagem imersivas. Diferente da simples diversão, a ABJ foca na construção de competências através da experimentação em um ambiente seguro, onde o erro é uma oportunidade de ajuste de estratégia e o estudante é o protagonista de sua jornada.

---

## 1. Organização por Padrões

Para implementar a ABJ de forma eficaz no contexto do [[Tecnico/Didatica/Planejamento/Modelo pedagogico Senac\|Modelo pedagogico Senac]] (MPS), a atividade deve ser estruturada sob quatro pilares:

### Padrão Sistêmico (O Ciclo de Aprendizagem)

A ABJ opera no ciclo **[[Tecnico/Didatica/Metodologias/Acao-reflexao-segunda-acao\|Ação-Reflexão-Ação]]**:
...
- [[Tecnico/Didatica/Metodologias/Metodologias ativas\|Metodologias ativas]]
- [[Tecnico/Didatica/Planejamento/Modelo pedagogico Senac\|Modelo pedagogico Senac]] (MPS)
- [[Tecnico/Didatica/Metodologias/Dojo\|Dojo]]
- [[Tecnico/Didatica/Metodologias/Gamificação\|Gamificação]]
