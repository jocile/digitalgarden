---
{"dg-publish":true,"permalink":"/42-turmas-senac-anteriores/programador/logica/aprendendo-logica-com-blocos/","metatags":{"description":"é uma maneira intuitiva e divertida de aprender e criar programas de computador"},"noteIcon":2,"updated":"2026-01-20T23:19:32.673-03:00","dg-note-properties":{}}
---
...
- [**Scratch:**](https://scratch.mit.edu/) - Uma plataforma popular para iniciantes, com interface amigável e grande comunidade online.
- [**Blockly:**](https://blockly.games/) - Ferramenta versátil utilizada em diversos projetos, incluindo desenvolvimento web e robótica.
- [**Code.org:**](https://studio.code.org/) - Oferece cursos e desafios interativos para aprender conceitos básicos de programação.
- [**App Inventor:** ](https://appinventor.mit.edu/) - Permite criar aplicativos Android utilizando blocos visuais.
...
> [!tip] Lembre-se que o Scratch é uma ferramenta poderosa que permite criar projetos incríveis. Com um pouco de prática e criatividade, você poderá dominar a plataforma e dar vida às suas ideias!
