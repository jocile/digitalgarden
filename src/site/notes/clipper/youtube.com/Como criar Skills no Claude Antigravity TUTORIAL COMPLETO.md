...
2. **Criar o `skills.md` (System Prompt):** Este arquivo é o cérebro da sua skill. Ele deve ser enxuto e conter:
    ...
    - **Passo a Passo ([[Inteligencia Artificial/Workflows\|Workflows]]):** Instruções lógicas sequenciais para a execução (20:45-21:30).
