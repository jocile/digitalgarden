---
{"dg-publish":true,"permalink":"/clipper/youtube-com/ai-studio-antigravity-supabase-criei-um-app-completo-do-zero-ao-deploy/","title":"AI Studio + Antigravity + Supabase: Criei um App COMPLETO do Zero ao Deploy (Tutorial)","noteIcon":2,"updated":"2026-03-12T22:02:15.816-03:00"}
---
...
📘 Guia Engenharia de [[Formacao/Inteligencia Artificial/Prompts\|Prompts]]: https://app.horadecodar.com.br/ebookpages/guia-engenharia-de-[[Formacao/Inteligencia Artificial/Prompts\|Prompts]]
...
Transfiro o projeto pro GitHub e abro no [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]]. Aqui é onde o app vira produto de verdade. Com um [[Formacao/Inteligencia Artificial/Prompts\|prompt]], o [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] via Supabase MCP cria o banco de dados com tabelas de receitas, configura autenticação com email e senha, implementa Row Level Security pra cada usuário só ver suas receitas, e cria uma Edge Function no Supabase pra chamar a API do Gemini sem expor a chave no frontend.
...
01:10 Explicando o [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Workflows\|Workflow]] do projeto (AI Studio + [[Tecnico/Ferramentas/ferramentas de IA/Antigravity/Antigravity\|Antigravity]])
