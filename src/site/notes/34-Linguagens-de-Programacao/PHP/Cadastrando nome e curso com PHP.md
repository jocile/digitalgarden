...
- **[[34-Linguagens-de-Programacao/PHP/Classes em PHP\|Classes em PHP]] e Objetos:** Criação da classe `Aluno` com atributos (`nome`, `curso`) e métodos (construtor `__construct`, getters).
...
- **Estruturas de [[34-Linguagens-de-Programacao/PHP/Repeticao com PHP\|Repeticao com PHP]] (`foreach`):** Para iterar sobre o array de alunos na sessão e exibi-los.
