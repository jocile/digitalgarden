...
> [!abstract] Neste artigo, vamos criar um chatbot utilizando a tecnologia Llama (Large Language Model Meta AI) em [[class/Python\|Python]]. Com Llama, podemos criar modelos de linguagem avançados que podem ser utilizados para realizar tarefas como responder perguntas, gerar texto e mais.
...
Depois de instalar o Llama, precisamos criar um ambiente virtual para que possamos instalar as dependências necessárias para nosso projeto. Isso pode ser feito utilizando a ferramenta `python -m venv` e criando um [[Formacao/Python/Ambientes virtuais/Ambientes virtuais com venv\|Ambientes virtuais com venv]] chamado "chatbot".

### Instalando Dependências

Com o ambiente virtual criado, precisamos instalar as dependências necessárias para nosso projeto. Isso inclui o módulo [[Formacao/Inteligencia Artificial/Langchain\|Langchain]], que é uma biblioteca que facilita a interação com os modelos de linguagem Llama.
