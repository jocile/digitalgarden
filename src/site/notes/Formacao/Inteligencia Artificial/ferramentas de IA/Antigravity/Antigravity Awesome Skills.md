---
{"dg-publish":true,"permalink":"/formacao/inteligencia-artificial/ferramentas-de-ia/antigravity/antigravity-awesome-skills/","metatags":{"description":"funcionam como superpoderes modulares que o agente de IA decide equipar apenas quando detecta que a tarefa"},"noteIcon":2,"updated":"2026-03-04T09:37:31.073-03:00"}
---

#ia #Projeto #Antigravity

O **[[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] Awesome [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Skills\|Skills]]** refere-se a um ecossistema de repositórios e marketplaces (como o do LobeHub) que disponibiliza pacotes de conhecimento especializado para a IDE Google [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]]. Essas habilidades funcionam como **"superpoderes" modulares** que o agente de IA decide "equipar" apenas quando detecta que a tarefa do usuário exige aquela expertise específica.
...
Diferente das _[[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Rules\|Rules]]_ (regras passivas sempre ativas no prompt de sistema), as habilidades utilizam o conceito de **Divulgação Progressiva (Progressive Disclosure)**.
...
- **Gatilho Automático:** Ao contrário dos _[[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Workflows\|Workflows]]_ (macros manuais disparadas por `/`), as habilidades são **acionadas automaticamente** pelo agente ao analisar a intenção da conversa.

### 2. Habilidades de Destaque no Ecossistema

Algumas das "Awesome [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Skills\|Skills]]" mais influentes mencionadas incluem:
...
Uma habilidade no [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] é organizada em um diretório contendo obrigatoriamente um arquivo **`SKILL.md`**. Este arquivo funciona como o "cérebro" da habilidade, contendo metadados YAML para indexação e instruções em [[Formacao/Webdesign/markdown\|markdown]] que definem o objetivo, passos e restrições da IA.

Para instalar essas habilidades da comunidade, o usuário pode simplesmente copiar o link do repositório GitHub e enviá-lo ao chat do [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]], solicitando a adição ao projeto global ou ao workspace local.
