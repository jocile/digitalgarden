...
O [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Workflows\|Workflow]] utilizado com as ferramentas gratuitas no vídeo para criar o aplicativo é o seguinte:
...
O [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Workflows\|Workflow]] utilizado com as ferramentas pagas no vídeo para criar o aplicativo é o seguinte:
...
No ecossistema atual de ferramentas agênticas do Google ([[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] e Stitch), a distinção entre planos gratuitos e pagos envolve principalmente **limites de uso (cotas)**, **capacidade de raciocínio dos modelos** e **infraestrutura de hospedagem**.

Abaixo estão os detalhes sobre como funcionam essas modalidades conforme as fontes:

### 1. Google Antigravity e AI Studio

- **Acesso Gratuito:** O [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] está disponível em "Public Preview" sem custo para indivíduos com contas pessoais do Gmail. Ele oferece uma cota gratuita para usar modelos premium como o Gemini 3 Pro.
...
Embora o plano gratuito seja excelente para **MVPs e prototipagem rápida**, as ferramentas pagas (como o Claude Code pago) oferecem um **raciocínio superior**, cometem menos erros básicos e são preparadas para **alta escala** e sistemas robustos que envolvem pagamentos e segurança complexa. Além disso, o uso de **[[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Skills\|Skill]]** e **[[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Workflows\|Workflow]]** no [[Formacao/Inteligencia Artificial/ferramentas de IA/Antigravity/Antigravity\|Antigravity]] ajuda a economizar tokens, o que é crucial para gerenciar os custos em qualquer um dos planos.
