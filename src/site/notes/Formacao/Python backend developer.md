---
{"dg-publish":true,"permalink":"/formacao/python-backend-developer/","title":"Python backend developer","metatags":{"description":"Lista de disciplinas da formação"},"tags":["Formação","Python"],"noteIcon":"default","updated":"2026-04-04T10:58:24.069-03:00","dg-note-properties":{"class":"classe-formacao","title":"Python backend developer","topics":["Python","Lógica de programação","[[Introdução aos algoritmos|Algoritmos]]"],"status":"🏗️ in-progress","horas-aula":"35:00","habilidades":["[[Python]]","POO","[[Django]]"],"link":"[DIO formacao-python-backend-developer](https://web.dio.me/track/formacao-python-backend-developer)","certificado":null,"started":null,"finished":null,"tags":["Formação","Python"]}}
---
...
**Horas-aula**: 35:00
**Habilidades**: [[assets/class/Python\|Python]],POO,[[Tecnico/Python/webapp/Django\|Django]]
