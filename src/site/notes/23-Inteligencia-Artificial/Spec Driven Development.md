---
{"dg-publish":true,"permalink":"/23-inteligencia-artificial/spec-driven-development/","metatags":{"description":"estruturando o contexto através de fases de pesquisa, planejamento e implementação "},"noteIcon":1,"updated":"2026-04-03T09:18:17.657-03:00","dg-note-properties":{"aliases":["SDD"],"topics":["Arquiteturas de Programação","Projetos de aplicativos"]}}
---
...
2. Inserindo um [[23-Inteligencia-Artificial/Product Requirement Document\|documento de requisitos]] (PRD) gigantesco de uma só vez, o que polui a janela de contexto, aumenta o custo de tokens e eleva drasticamente a chance de alucinações.
...
- **[TLC Spec-Driven Skill](https://mcpmarket.com/tools/skills/spec-driven-development-tlc):** Uma [[23-Inteligencia-Artificial/Skills\|Skill]] global altamente flexível para estruturar specs e tarefas.
...
#sdd #Inteligencia-artificial #Projeto [[23-Inteligencia-Artificial/Product Requirement Document\|Product Requirement Document]]
