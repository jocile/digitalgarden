...
- **Extensibilidade:** Conexão com MCPs ([[23-Inteligencia-Artificial/Model Context Protocol\|Model Context Protocol]]) externos como **n8n** (automação) e **Firecrawl** (scraping).
...
Capacidades modulares que podem ser adicionadas. Exemplo: a [[23-Inteligencia-Artificial/Skills\|Skill]] **Remotion**, que permite à IA gerar e editar vídeos programaticamente a partir de código.
...
- [[31-Clipper/youtube.com/Como usar o Google Antigravity melhor que 99% das pessoas\|Como usar o Google Antigravity melhor que 99% das pessoas]]
