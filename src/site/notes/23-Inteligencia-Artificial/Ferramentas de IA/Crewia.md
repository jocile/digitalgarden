---
{"dg-publish":true,"permalink":"/23-inteligencia-artificial/ferramentas-de-ia/crewia/","metatags":{"description":"permite a criação de equipes de agentes de Inteligência Artificial."},"noteIcon":"1","updated":"2026-04-01T14:50:22.809-03:00","dg-note-properties":{}}
---

#Inteligencia-artificial  #Ferramentas #Agentes #framework #Python 

# CrewIA

CrewAI é um framework de orquestração multiagente em Python que permite a criação de equipes de [[23-Inteligencia-Artificial/agentes/agentes de ia\|agentes de Inteligência Artificial]] (IA) para automatizar fluxos de trabalho e resolver tarefas complexas de forma colaborativa. Criado pelo brasileiro João Moura, o projeto simula uma equipe de trabalho humana, onde agentes com funções, objetivos e históricos (backstory) específicos cooperam para alcançar um resultado comum.
...
- [[23-Inteligencia-Artificial/Ferramentas de IA/Instalando Crewia\|Instalando Crewia]]
- [[23-Inteligencia-Artificial/Cursos de Inteligência Artificial\|Cursos de Inteligência Artificial]]
