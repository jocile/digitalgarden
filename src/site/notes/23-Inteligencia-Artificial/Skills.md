---
{"dg-publish":true,"permalink":"/23-inteligencia-artificial/skills/","metatags":{"description":"são como playbooks que a IA lê para executar tarefas específicas, tornando-se especialista no seu negócio"},"noteIcon":2,"updated":"2026-06-11T07:36:29.149-03:00","dg-note-properties":{"aliases":["Skill"],"topics":["Live coding","Automação"]}}
---
...
| Modelo            | ✅                                                | ✅                                                                               |
| [[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]] | Todas instruções ficam no System Prompt          | System Prompt leve + skills ([[23-Inteligencia-Artificial/Prompts\|Prompts]]) carregados [[23-Inteligencia-Artificial/Workflows\|sob demanda]] |
...
- **[[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]] Mais Enxuto e Eficiente**: Enquanto os agentes tradicionais precisam ter todas as instruções no "[[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]]", as skills permitem que o "[[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]]" seja mais limpo, apenas indicando a disponibilidade dos "playbooks" externos (as skills). O conteúdo detalhado da skill é carregado apenas quando necessário ([[23-Inteligencia-Artificial/Workflows\|23-Inteligencia-Artificial/Workflows]]).
...
- **Progressive Disclosure (Preservação da Janela de Contexto)**: As skills utilizam a janela de contexto de forma mais eficiente. Elas são carregadas apenas quando são necessárias, preservando a janela de contexto e tornando a IA mais efetiva. O "[[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]]" do agente apenas lista os nomes e descrições curtas das skills disponíveis, carregando o conteúdo completo de uma skill apenas se ela for solicitada ou ativada. Isso evita lotar a janela de contexto com informações que não são relevantes para a tarefa atual, o que acontece quando todas as instruções estão diretamente no "[[23-Inteligencia-Artificial/parametros de LLM/System Prompt\|System Prompt]]" do agente.
...
- **Stitch Skills:** Quando integradas ao Google Stitch via MCP ([[23-Inteligencia-Artificial/Model Context Protocol\|Model Context Protocol]]), permitem converter layouts em arquivos **design.md** (fonte da verdade), gerar componentes **React/TypeScript** modulares e criar o **Stitch Loop** (automação para gerar múltiplas páginas em segundo plano).
...
- [[23-Inteligencia-Artificial/Ferramentas de IA/Antigravity/Antigravity Awesome Skills\|Antigravity Awesome Skills]]
- [[23-Inteligencia-Artificial/Ferramentas de IA/Antigravity/Antigravity Kit\|Antigravity Kit]]
- [[23-Inteligencia-Artificial/Repositórios de Skills\|Repositórios de Skills]]
