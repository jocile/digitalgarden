---
{"dg-publish":true,"permalink":"/32-formacao/python-developer/","title":"Python developer","metatags":{"description":"Lista de disciplinas da formação"},"tags":["Formação","Python","Estrutura"],"noteIcon":"default","updated":"2026-04-05T10:59:45.244-03:00","dg-note-properties":{"class":"classe-formacao","title":"Python developer","topics":["Python","Lógica de programação","[[Introdução aos algoritmos|Algoritmos]]"],"status":"🏗️ in-progress","horas-aula":64,"habilidades":["[[Python]]","Lógica","Estrutura de dados"],"link":"[DIO Python Developer](https://web.dio.me/track/formacao-python-developer)","certificado":null,"started":null,"finished":null,"tags":["Formação","Python","Estrutura"]}}
---
...
**Horas-aula**: 64
**Habilidades**: [[01-Controles/class/Python\|Python]],Lógica,Estrutura de dados
