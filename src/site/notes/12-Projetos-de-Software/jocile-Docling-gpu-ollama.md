...
- **Deploy/Ambiente**: Local (Windows/Linux) via ambiente virtual Python (`venv`) com PyTorch CUDA 13.5

## ⚙️ DevOps & Manutenção

- [ ] Revisar alertas semanais do Dependabot
- [ ] Atualizar documentação baseada em Spec-Driven Development (SDD)
