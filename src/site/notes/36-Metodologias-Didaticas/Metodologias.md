---
{"dg-publish":true,"permalink":"/36-metodologias-didaticas/metodologias/","metatags":{"description":"conjunto de procedimentos didáticos que visam promover a participação ativa do aluno nas situações de aprendizagem."},"noteIcon":2,"updated":"2026-03-15T10:24:43.743-03:00","dg-note-properties":{"topics":["Didática de aula"]}}
---


## Métodos de aprendizagem ativa

Atuar com as [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] requer ressignificar o papel do docente. Na perspectiva da [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] ativa, ressignificar o papel do professor exige deslocar o papel de docente da figura de sujeito detentor do conhecimento para uma atuação mais próxima da tutoria.

Analisando as [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] em relação à Educação Profissional e ao desenvolvimento de competências, pode-se dizer que:  

- Não há um método de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] ativa que seja mais ou menos indicado para o desenvolvimento de competências. 
- Apesar de revelarem elementos comuns, cada método referenciado na literatura educacional sobre [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] ativa apresenta variações em seus pressupostos teóricos e didáticos. 
- A escolha por um ou outro método de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] ativa pode variar em função dos recursos disponíveis, do planejamento das situações de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] ou até mesmo da preferência do docente.  

A perspectiva da [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] com a utilização de [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] organiza-se a partir de algumas premissas:  

- O trabalho em equipe é estimulado porque favorece a interação entre os alunos em atividades coletivas.  
- As atividades que permitem o trabalho colaborativo entre os alunos são adotadas porque essa prática será exigida deles futuramente, na vida profissional.

Entende-se por [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] um conjunto de procedimentos didáticos que visam promover a participação ativa do aluno nas situações de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]]. Os principais elementos que as caracterizam são: o foco da ação pedagógica no aluno, a presença do docente como mediador do processo de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] e o caráter colaborativo e participativo das atividades desenvolvidas em sala de aula.

As [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de ensino e [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]], em consonância com os pressupostos e orientações para o desenvolvimento de competências no Modelo Pedagógico Senac, devem estar alicerçadas na concepção de aluno como sujeito de seu desenvolvimento educacional.\
O termo destacado pressupõe, como premissa, que o papel do docente deva ser o de mediar o processo de ensino e [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]].\
As [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] favorecem o desenvolvimento da autonomia pelo aluno, que, em vez de receber de forma passiva as informações apresentadas pelo professor, é estimulado a buscar dados, realizar pesquisas, manifestar-se e adotar uma postura crítica em relação à realidade à sua volta. Para tanto, o papel do professor deve ser o de orientar, acompanhar e facilitar o processo de ensino e [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]], sendo, portanto, um mediador desse processo.

As estratégias de [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] constituem uma possibilidade entre várias existentes para o planejamento das aulas e a atuação docente, além de permitir o desenvolvimento da inovação na [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]], em sintonia com a educação do século XXI. Sobre esse conceito, é possível afirmar que:  

- Destaca o caráter dinâmico desses métodos e estratégias, pois, na prática, eles acontecem de maneira articulada.  
- A metodologia é fundamental, mas não pode ser tomada como um instrumento rigoroso de técnicas e procedimentos, nem ganhar maior importância do que a própria vivência em sala de aula.  
- O uso de [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] reforça as noções de autonomia, emancipação e desenvolvimento pessoal de alunos e docentes, que, pela via do respeito e da valorização das diferenças, aprendem juntos.  
- Não se trata de técnicas atraentes para transmitir conteúdos aos alunos. Significa uma mudança de postura, uma forma de repensar a escola, o currículo e a prática pedagógica em si.

No trabalho com [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]], o docente tem um importante papel de facilitar reflexões e ajudar o aluno a fazer as conexões necessárias à construção do conhecimento. Isso significa que são esperadas do docente ações como fazer perguntas capazes de desafiar os alunos na busca de soluções. Sua ação ganha acento na mediação. Nesse papel, ele considera as informações trazidas pelos alunos e constrói significados coletivos com a sala de aula.

A inovação é bastante estimulada no trabalho com [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]] de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]], e algumas das justificativas para essa prática são:  
...
- Situação-problema
- [[36-Metodologias-Didaticas/Estudo de Caso\|Estudo de Caso]]
- Projeto
- Pesquisa
- Jogos coletivos
- Estudo do meio
...
- Dramatização
- Visita Técnica
- Laboratório de práticas: [[36-Metodologias-Didaticas/Dojo\|Dojo]]
- Palestra
- Melhores práticas e Benchmarking
- Brainstorming
- Trabalho de grupo
- Apresentação vivencial - Dinâmica
- [[36-Metodologias-Didaticas/Aprendizagem baseada em problemas\|Aprendizagem baseada em problemas]]
- Seminário
- Portfólio
- Debate
- Relatório
- [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] em ação
- Mapa Mental
- Painel
- Produção de vídeo/Videoclipe
- Exposição prática

### Aprendizagem Baseada em Problemas

A [[36-Metodologias-Didaticas/Aprendizagem baseada em problemas\|Aprendizagem baseada em problemas]] (ABP) é um método de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] que se baseia na apresentação de um problema aos alunos, com o objetivo de mobilizá-los para a busca de possíveis soluções. Nessa abordagem, **a curiosidade é a base** para a elaboração de perguntas acerca dos fenômenos complexos que envolvem o cotidiano do aluno e sua realidade profissional, **buscando despertar o interesse e provocar a reflexão**.

Apesar de o problema ser a base para o aprendizado, a ideia é enfatizar o processo de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] do grupo na busca de uma solução, o que não significa que o problema tenha de ser necessariamente resolvido. A principal contribuição dessa metodologia é a construção do conhecimento em um ambiente de colaboração mútua.

As demais etapas de trabalho na [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] Baseada em Problemas (ABP) envolvem:

- o levantamento dos conhecimentos sobre o assunto;
- a análise das variáveis do problema;
- a proposta de possíveis soluções;
- a busca de referências para qualificar as respostas;
- o debate para a busca de consenso sobre as possíveis soluções;
- e a apresentação de respostas e avaliação dos resultados.
...
Na [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] Baseada em Casos (ABC) os casos são construídos ou selecionados a partir dos indicadores de competência e dos elementos a serem mobilizados na Unidade Curricular. Sobre a ABC, pode-se dizer que:  

- O caso pode conter informações simples ou complexas, e o docente pode disponibilizar gráficos, tabelas e figuras para subsidiar a análise dos alunos. 
- Há casos que apresentam o relato completo de uma situação com sua respectiva solução, enquanto outros são menos estruturados e apresentam perguntas fechadas, para que os alunos encontrem uma solução. 
- Um caso deve envolver questões que provoquem o debate e o surgimento de diferentes perspectivas de análise, de maneira a oferecer mais de uma resposta certa.

### Sala de aula invertida

A sala de aula invertida é o método que **inverte a sequência tradicional das situações de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]]**. Nessa proposta, os alunos realizam leituras e pesquisas antes dos encontros presenciais, por meio de recursos como textos, vídeos e áudios. Podem também participar de chats, fóruns, jogos e de outras atividades interativas. Posteriormente, os alunos discutem a temática com o docente e os demais colegas para, então, desenvolver atividades relacionadas à temática.
...
A possibilidade de concentrar no ambiente virtual as informações necessárias para o desenvolvimento do curso é o grande atrativo desse método, já que se **amplia o tempo disponível para explorar situações de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] mais focadas no exercício da competência**, em vez de apenas explanações tradicionais.
...
Para a escolha do jogo, é fundamental **estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] e o perfil dos alunos** – considerando as possibilidades que as tecnologias assistivas oferecem –, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho.
...
A [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] Baseada em Jogos constitui uma abordagem que utiliza os jogos, em sua perspectiva lúdica, em atividades com finalidades educacionais. Nessa metodologia, o docente pode utilizar jogos educativos nos formatos digitais ou físicos, ou até mesmo criar seus próprios jogos.

A escolha do jogo, é fundamental estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] e o perfil dos alunos, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho.

Em uma perspectiva mais atual, o docente pode desenvolver jogos baseados nos elementos e nas dinâmicas dos videogames, nos quais a ação se desenvolve sob um enredo e uma narrativa, com desafios e níveis de dificuldade e progressão. Há, portanto, diversas formas de apropriação dos jogos em contextos pedagógicos. Os jogos educativos, por exemplo, são desenvolvidos para abordar temas relacionados ao currículo, inclusive aqueles relacionados ao desenvolvimento de habilidades, atitudes e valores, tais como integração, empreendedorismo, cooperação e controle das emoções. Para a escolha do jogo, é fundamental estabelecer relações entre os indicadores e elementos de competência, os objetivos de [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] e o perfil dos alunos, de forma a relacionar as experiências vivenciadas no jogo com as situações reais do mundo do trabalho. É também importante que todos esses elementos sejam organizados sob regras claras, com previsão das possibilidades de tentativa e erro, interatividade e interação entre os alunos.

A [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] Baseada em Jogos (gamificação) traz para o universo da sala de aula a dinâmica, a mecânica e os componentes estruturais dos jogos. Dessa forma, os elementos comuns de jogos são utilizados no processo educacional, para além do mero entretenimento, com a finalidade de desafiar o raciocínio e propiciar a [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]]. As etapas para a utilização da [[36-Metodologias-Didaticas/Aprendizagem\|Aprendizagem]] Baseada em Jogos envolvem:  
...
- Âncora - introduz o problema ou a questão a ser considerada;
- Trabalho em equipe cooperativo - envolve o planejamento e especificação dos papéis dos membros do grupo;
- Questão motriz - Foco que direciona os esforços, junto à âncora, permite saber quais informações reunir;
- Feedback e revisão - avaliações e auto-avaliações sempre presentes que motivam o alcance do resultado, e podem promover uma mudança de rota;
- Investigação e inovação - meios para avançar no planejamento e pesquisas para desenvolvimento;
- oportunidades e reflexão - brainstorming de ideias e ferramentas sobre o tema e aprendizado;
- Processo de investigação - linhas de tempo, metas, procedimentos, mapas conceituais, laboratórios, etc.;
- Resultados apresentados publicamente - congresso, jornais, revistas, blogs, etc.;
- Voz e escolha dos alunos - os Alunos devem ser ativos em todas as fazes e ver o significado de sua realização.

## Referências

- [[36-Metodologias-Didaticas/Cubus\|Cubus]]
- [Home - Plataforma Cubus](https://cubus.oitcinterfor.org/)
- [Espaço Docente Senac](https://espacodocente.senac.br)
