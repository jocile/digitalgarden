...
Dentro do [[36-Metodologias-Didaticas/Modelo pedagogico Senac\|Modelo Pedagógico Senac]] (MPS), a gamificação desloca o centro da aula da exposição para a experiência:
...
*   **Ciclo [[36-Metodologias-Didaticas/Acao-reflexao-segunda-acao\|Ação-Reflexão-Ação]]:** O aluno realiza uma missão (ação), analisa seu desempenho e pontuação (reflexão) e ajusta sua estratégia para o próximo nível (nova ação).
...
1.  **Briefing da Missão (Desafio Provocador):** Apresentação do problema real contextualizado em uma narrativa (ex: "Sua agência de marketing precisa salvar uma empresa em crise").
2.  **Gameplay (Ação):** As equipes executam as tarefas técnicas sob pressão de tempo, acumulando pontos e superando obstáculos.
3.  **Boss Battle (Desafio Final):** Uma atividade integradora que exige o uso de todos os conhecimentos adquiridos na fase.
4.  **Debriefing (Retrospectiva):** O momento mais importante. Discussão coletiva sobre o que foi aprendido, quais estratégias técnicas foram eficazes e como isso se aplica à vida profissional.
...
*   **Estruturação:** [Classcraft](https://www.classcraft.com/), [Gametize](https://gametize.com/).
*   **Quizzes e Revisão:** [Kahoot!](https://kahoot.it/), [Quizizz](https://quizizz.com/).
*   **Colaboração Visual:** [Miro](https://miro.com/) ou [Mural](https://mural.co/) para mapear o progresso das missões.

---

## Referências

- [Gamificação \| Plataforma Cubus](https://cubus.oitcinterfor.org/gamificacao)
- [[36-Metodologias-Didaticas/Metodologias ativas\|Metodologias ativas]]
- [[36-Metodologias-Didaticas/Modelo pedagogico Senac\|Modelo pedagogico Senac]]
